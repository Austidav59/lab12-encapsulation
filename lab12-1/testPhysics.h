...
private:
    ...
    *********************************************************/
    void linearInterpolation_coordinatesZero() {
        // setup values for interpolation at (d,r) == (d0,r0)
        double d0 = 0.0;
        double r0 = 0.0;
        double d1 = 8.0;
        double r1 = 8.0;
        
        // exercise interpolation at d == d0
        double r_result = linearInterpolation(d0, r0, d1, r1, d0);

        // verify result is equal to r at d == d0
        assertEquals(r_result, r0);
    }
    ...
    *********************************************************/
    void linearInterpolation_coordinatesOne() {
         // setup values for interpolation at (d,r) == (d1,r1)
         double d0 = 0.0;
         double r0 = 0.00;
         double d1 = 8.00;
         double r1 = 8.00;

         // exercise interpolation at d == d1
         double r_result = linearInterpolation(d0, r0, d1, r1, d1);

         // verify result is equal to r at d == d1
         assertEquals(r_result, r1);
    }
   /*********************************************************
    ...
    *****************************************************************/
    ...
    void speedSoundFromAltitude_0()
    {
        // setup
        double altitude = 0.0;
        double speedSound = -999.999;

        // exercise
        speedSound = speedSoundFromAltitude(altitude);

        // verify
        assertEquals(speedSound, 340.0);
        assertEquals(altitude, 0.0);
    }
